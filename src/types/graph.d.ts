...
export interface Mutation {
  ...
  UpdateMyProfile: UpdateMyProfiletypeResponse;
}
...
export interface UpdateMyProfiletypeResponse {
  ok: boolean;
  error: string | null;
}
